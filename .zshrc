...
# Ensure the PATH contains unique values, even after mutliple sources
typeset -U path
...
# Aliases to automatically use NeoVim instead of just Vim
alias vim='nvim'

# Enabling proper work of the fuzzy finder
[ -f /usr/share/doc/fzf/examples/key-bindings.zsh ] && source /usr/share/doc/fzf/examples/key-bindings.zsh
[ -f /usr/share/doc/fzf/examples/completion.zsh ] && source /usr/share/doc/fzf/examples/completion.zsh

# Grouping custom binary paths for NeoVim configuration
# Adds Neovim and personal bin folder to the front of the list
